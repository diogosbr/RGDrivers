...
#'
#' Esta função adiciona a uma tabela de trechos fluviais a coluna `D_LINK`, que representa
#' o valor da ordem (ex: Link Magnitude) do trecho jusante.
#'
#' @param df Data frame contendo os trechos da rede hidrográfica
#' @param col_id Nome da coluna com ID único dos trechos (ex: "cotrecho")
