...
R package for stream network analysis, focused on connectivity metrics, order calculation (such as Link Magnitude), and spatial manipulation integrated with `terra`, `igraph`, and `sf`.
...
This example uses a small set of fictional line reaches included in the package.
